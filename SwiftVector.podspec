#
#  Be sure to run `pod spec lint SwiftVector.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Paul Franceus" => "paul@blueiris.us" }
  # Or just: s.author    = "Paul Franceus"
  # s.authors            = { "Paul Franceus" => "paul@blueiris.us" }
  # s.social_media_url   = "http://twitter.com/Paul Franceus"
